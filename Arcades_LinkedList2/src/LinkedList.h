...
/**
 * @brief testeo para agrar un nodo
 *
 * @param this lista
 * @param nodeIndex posicion
 * @param pElement elemento
 * @return entero
 */
...
/**
 * @brief permite efectuarle un cambio que indique el puntero a función invocado
 *
 * @param this lista
 * @param pFunc puntero a función
 * \return int Retorna  (-1) Error: si alguno de los punteros a las listas son NULL
 *                      ( 1) Si los elementos de (this2) estan contenidos en la lista (this)
 *                      ( 0) si los elementos de (this2) NO estan contenidos en la lista (this)
 */
